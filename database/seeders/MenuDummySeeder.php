 ...
 *
 * Generate dummy data menu harian MBG untuk April & Mei 2026.
...
class MenuDummySeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $this->command->info('');
        $this->command->info('─── [3/3] Menu Harian April & Mei 2026 ───');
        ...
        foreach (array_keys($this->bahanConfig) as $key) {
            ...
            if (!$exists) {
                DB::table('harga_bahans')->insert([
                    ...
                    'berlaku_sampai'  => null,
                    'keterangan'      => 'Dummy — seeder April–Mei 2026',
                    'created_at'      => $now,
                    'updated_at'      => $now,
                ]);
    ...
    private function seedMenuHarian(int $userId, $now): void
    {
        ...
        $this->command->info("  ✓ Periode  : Selasa 1 April – Sabtu 17 Mei 2026 (hari kerja)");
    }
}